...
export default function HeaderPage() {
    ...
    return (
        <nav className="bg-gray-400 dark:bg-gray-900">
            <div className="mx-auto max-w-7xl px-2 sm:px-6 lg:px-8">
                <div className="relative flex h-16 items-center justify-between">
                    ...
                    <div className="flex flex-1 items-center justify-center sm:items-stretch sm:justify-start">
                        ...
                        <div className="hidden sm:ml-6 sm:block">
                            <div className="flex space-x-4">
                                <a href="#" className="rounded-md px-3 py-2 text-sm font-medium text-gray-900 hover:bg-red-700 hover:text-white dark:text-white">Dashboard</a>
                                <a href="#" className="rounded-md px-3 py-2 text-sm font-medium text-gray-900 hover:bg-red-700 hover:text-white dark:text-white">Team</a>
                                <a href="#" className="rounded-md px-3 py-2 text-sm font-medium text-gray-900 hover:bg-red-700 hover:text-white dark:text-white">Projects</a>
                                <a href="#" className="rounded-md px-3 py-2 text-sm font-medium text-gray-900 hover:bg-red-700 hover:text-white dark:text-white">Calendar</a>
                            </div>
                        </div>
                    </div>
                    <div className="absolute inset-y-0 right-0 flex items-center pr-2 sm:static sm:inset-auto sm:ml-6 sm:pr-0">
                        ...
                        <button onClick={handleDarkMode} className="bg-black p-1 rounded-3xl dark:bg-white text-white dark:text-black">DarkMode</button>
